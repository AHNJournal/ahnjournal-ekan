 ...
 *   description = @Translation("Adds resource to groups as pure entities."),
 *   entity_type_id = "resource",
 *   entity_access = TRUE,
 *   pretty_path_key = "resource",
 *   reference_label = @Translation("title"),
 *   reference_description = @Translation("The title of the resource (entity) to add to the group."),
 *   handlers = {
 ...
 * )
 */
class ResourceEntity extends GroupContentEnablerBase {
